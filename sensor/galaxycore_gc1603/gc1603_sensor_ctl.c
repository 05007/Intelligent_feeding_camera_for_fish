...
/* 72P@120fps LINEAR; Raw:10Bit; MCLK Input: 27MHz; MIPI CLK: 630Mbps/lane; CSI-2 2Lane */
int gc1603_linear_720p120_init(VI_PIPE ViPipe)
{
    int ret = SC_FAILURE;
