...
SC_S32 SAMPLE_H265_VDEC_VPSS_VO(SC_VOID)
{
    ...
    *************************************************/
    ...
    abChnEnable[1] = SC_TRUE;
    astVpssChnAttr[1].u32Width                    = 1280;// stDispSize.u32Width;
    astVpssChnAttr[1].u32Height                   = 720;//stDispSize.u32Height;
    ...
    astVpssChnAttr[1].bMirror                     = SC_FALSE;
    astVpssChnAttr[1].bFlip                       = SC_FALSE;
...
SC_S32 SAMPLE_IVE_RESZIE(VIDEO_FRAME_INFO_S *pstVFrame, int w, int h)
{
    SC_S32 s32Ret;
    ...
    sCropInfo.stCropRect.u32Width = w;
    sCropInfo.stCropRect.u32Height = h;
