...
#if 0 //todo
SC_VOID SAMPLE_COMM_VO_HdmiConvertSync(VO_INTF_SYNC_E enIntfSync,
    SC_HDMI_VIDEO_FMT_E *penVideoFmt)
{
    switch (enIntfSync)
    {
    case VO_OUTPUT_PAL:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_PAL;
        break;
    case VO_OUTPUT_NTSC:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_NTSC;
        break;
    case VO_OUTPUT_1080P24:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_1080P_24;
        break;
    case VO_OUTPUT_1080P25:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_1080P_25;
        break;
    case VO_OUTPUT_1080P30:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_1080P_30;
        break;
    case VO_OUTPUT_720P50:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_720P_50;
        break;
    case VO_OUTPUT_720P60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_720P_60;
        break;
    case VO_OUTPUT_1080I50:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_1080i_50;
        break;
    case VO_OUTPUT_1080I60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_1080i_60;
        break;
    case VO_OUTPUT_1080P50:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_1080P_50;
        break;
    case VO_OUTPUT_1080P60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_1080P_60;
        break;
    case VO_OUTPUT_576P50:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_576P_50;
        break;
    case VO_OUTPUT_480P60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_480P_60;
        break;
    case VO_OUTPUT_800x600_60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_VESA_800X600_60;
        break;
    case VO_OUTPUT_1024x768_60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_VESA_1024X768_60;
        break;
    case VO_OUTPUT_1280x1024_60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_VESA_1280X1024_60;
        break;
    case VO_OUTPUT_1366x768_60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_VESA_1366X768_60;
        break;
    case VO_OUTPUT_1440x900_60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_VESA_1440X900_60;
        break;
    case VO_OUTPUT_1280x800_60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_VESA_1280X800_60;
        break;
    case VO_OUTPUT_1920x2160_30:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_1920x2160_30;
        break;
    case VO_OUTPUT_1600x1200_60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_VESA_1600X1200_60;
        break;
    case VO_OUTPUT_1920x1200_60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_VESA_1920X1200_60;
        break;
    case VO_OUTPUT_2560x1440_30:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_2560x1440_30;
        break;
    case VO_OUTPUT_2560x1600_60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_2560x1600_60;
        break;
    case VO_OUTPUT_3840x2160_30:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_3840X2160P_30;
        break;
    case VO_OUTPUT_3840x2160_60:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_3840X2160P_60;
        break;
    default:
        *penVideoFmt = SC_HDMI_VIDEO_FMT_1080P_60;
        break;
...
{
    SC_HDMI_ATTR_S      stAttr;
    SC_HDMI_VIDEO_FMT_E enVideoFmt;
    SC_HDMI_ID_E        enHdmiId    = SC_HDMI_ID_0;

    SAMPLE_COMM_VO_HdmiConvertSync(enIntfSync, &enVideoFmt);

    CHECK_RET(SC_MPI_HDMI_Init(), "SC_MPI_HDMI_Init");
    CHECK_RET(SC_MPI_HDMI_Open(enHdmiId), "SC_MPI_HDMI_Open");
    CHECK_RET(SC_MPI_HDMI_GetAttr(enHdmiId, &stAttr), "SC_MPI_HDMI_GetAttr");
    stAttr.bEnableHdmi           = SC_TRUE;
    stAttr.bEnableVideo          = SC_TRUE;
    stAttr.enVideoFmt            = enVideoFmt;
    stAttr.enVidOutMode          = SC_HDMI_VIDEO_MODE_YCBCR444;
    stAttr.enDeepColorMode       = SC_HDMI_DEEP_COLOR_24BIT;
    stAttr.bxvYCCMode            = SC_FALSE;
    stAttr.enOutCscQuantization  = HDMI_QUANTIZATION_LIMITED_RANGE;

    stAttr.bEnableAudio          = SC_FALSE;
    stAttr.enSoundIntf           = SC_HDMI_SND_INTERFACE_I2S;
    stAttr.bIsMultiChannel       = SC_FALSE;

    stAttr.enBitDepth            = SC_HDMI_BIT_DEPTH_16;

    stAttr.bEnableAviInfoFrame   = SC_TRUE;
    stAttr.bEnableAudInfoFrame   = SC_TRUE;
    stAttr.bEnableSpdInfoFrame   = SC_FALSE;
    stAttr.bEnableMpegInfoFrame  = SC_FALSE;

    stAttr.bDebugFlag            = SC_FALSE;
    stAttr.bHDCPEnable           = SC_FALSE;

    stAttr.b3DEnable             = SC_FALSE;
    stAttr.enDefaultMode         = SC_HDMI_FORCE_HDMI;

    CHECK_RET(SC_MPI_HDMI_SetAttr(enHdmiId, &stAttr), "SC_MPI_HDMI_SetAttr");
    CHECK_RET(SC_MPI_HDMI_Start(enHdmiId), "SC_MPI_HDMI_Start");
...
SC_S32 SAMPLE_COMM_VO_HdmiStartByDyRg(VO_INTF_SYNC_E enIntfSync, DYNAMIC_RANGE_E enDyRg)
{
    ...
    memset(&stAttr, 0, sizeof(SC_HDMI_ATTR_S));
    ...
    case DYNAMIC_RANGE_HDR10:
        stAttr.enVidOutMode    = SC_HDMI_VIDEO_MODE_YCBCR422;
        break;
    default:
        stAttr.enDeepColorMode = SC_HDMI_DEEP_COLOR_24BIT;
        break;
...
SC_S32 SAMPLE_COMM_VO_HdmiStop(SC_VOID)
{
    ...
    CHECK_RET(SC_MPI_HDMI_Stop(enHdmiId), "SC_MPI_HDMI_Stop");
    CHECK_RET(SC_MPI_HDMI_Close(enHdmiId), "SC_MPI_HDMI_Close");
    CHECK_RET(SC_MPI_HDMI_DeInit(), "SC_MPI_HDMI_DeInit");
