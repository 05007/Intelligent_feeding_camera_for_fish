...
static const SC_COMBO_DEV_ATTR_S MIPI_2lane_CHN0_SENSOR_GC1603_10BIT_1M_NOWDR_ATTR =
{
    .devno      = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = 630,
...
static const VI_PIPE_ATTR_S PIPE_ATTR_1280x720_RAW10_420_3DNR_RFR =
{
    VI_PIPE_BYPASS_NONE, SC_FALSE, SC_FALSE,
    1280, 720,
    PIXEL_FORMAT_RGB_BAYER_10BPP,
    ...
    SC_COMBO_DEV_ATTR_S *pstComboAttr)
{
    ...
    case GALAXYCORE_GC1603_MIPI_1M_120FPS_10BIT:
        memcpy_s(pstComboAttr, sizeof(SC_COMBO_DEV_ATTR_S), &MIPI_2lane_CHN0_SENSOR_GC1603_10BIT_1M_NOWDR_ATTR,
            sizeof(SC_COMBO_DEV_ATTR_S));
        break;
